...
export default function CheckoutPage(){
    return <Container className="mt-10">
        ...
        <WhiteBlock title="1. Корзина">ccs</WhiteBlock>
        ...
        <div className="w-[450px]">
            <WhiteBlock className="p-6 sticky top-4">
                <div className="flex flex-col gap-1">
                    ...
                    <span className="text-[34px] font-extrabold">3564</span>
                </div>
                ...
                <Button type="submit" className="w-full h-14 rounded-2xl mt-6 text-base font-bold">Перейти к оплате
